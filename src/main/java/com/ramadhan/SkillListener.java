...
public class SkillListener implements Listener {
    ...
    private void drawMoon(Player p, double rot) {
        ...
        for (double t = -1.7; t <= 1.7; t += 0.03) {
            ...
            double x = Math.cos(t) * 1.1 * taper;
            double y = Math.sin(t) * 1.1;
            ...
            p.getWorld().spawnParticle(Particle.DUST, pLoc, 1, new Particle.DustOptions(Color.fromRGB(255, 215, 0), 0.5f));
        }
    }
